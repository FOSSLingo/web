...
export const LessonCard = ({ 
  ...
  return (
    <div className='w-full h-50 bg-[#0f0f0f] rounded-[40] items-center justify-center flex flex-col'>
      <h1 className="font-bold text-2xl pb-3">{lesson}</h1>
      <div className="flex gap-1 w-full px-4">
        <div className="flex flex-grow w-full bg-[#1f1f1f] rounded-tl-[40] rounded-bl-[40] rounded-br-xl rounded-tr-xl">
