  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="flex min-h-[10vh] sm:min-h-[40vh] md:min-h-[30vh] lg:min-h-[20vh] flex-col items-center justify-center p-6">
          <div className='text-center'>
            <p className="max-w-2xl text-lg md:text-xl">
              ...
              <br/><strong>French (Worldwide)</strong>.<br/> Once the project gains
        ...
        <section className="flex min-h-[10vh] sm:min-h-[40vh] md:min-h-[30vh] lg:min-h-[20vh] flex-col items-center justify-center p-6">
          <div className='text-center'>
            <h2 className="text-2xl">Why was French chosen?</h2>
            <p className="max-w-2xl text-lg md:text-xl">
              French was chosen as it is the secondary language used in Canada, the
              place where I, iddu01 am residing in. That means it is easily learnable
              at school, which will help me integrate it as a course to FOSSLingo.
            </p>
          </div>
        </section>
        <Footer/>
